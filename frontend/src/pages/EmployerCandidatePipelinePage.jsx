...
import { FiArrowLeft, FiSliders, FiBriefcase } from 'react-icons/fi';

const EmployerCandidatePipelinePage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 min-h-[calc(100vh-4rem)]">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 rounded-3xl p-8 text-white shadow-xl mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border border-slate-800">
        <div>
          ...
          <p className="mt-2 text-slate-300 text-sm">
            Drag and drop candidate application cards across workflow columns to update candidate statuses in real-time.
          </p>
        </div>
      ...
      {/* Main Drag and Drop Pipeline Component */}
      <KanbanBoard />
    </div>
  );
};

export default EmployerCandidatePipelinePage;

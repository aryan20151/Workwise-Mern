...
router.get('/companies/my-listings', requireAuth, authorizeRoles('employer', 'admin'), getMyCompanies);
...
router.get('/requisitions/my-listings', requireAuth, authorizeRoles('employer', 'admin'), getMyRequisitions);
